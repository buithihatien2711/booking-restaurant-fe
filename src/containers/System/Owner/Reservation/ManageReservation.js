...
export class ManageReservation extends Component {
  ...
  handleChangeStatus = async (selectedValue, reservation) => {
    ...
    try {
      let res = await handleChangeReservationStatus(reservation.id, selectedValue)
      if(res.data.success) {
                      ...
                      <tr key={index}>
                        ...
                        <td style={{ textAlign: "center" }}>
                          <Select data={statuses}
                            selectedIndex={reservation && reservation.reservationStatus ? reservation.reservationStatus : null} 
                            onChange={this.handleChangeStatus} containElement={reservation}
                          />
                        </td>
                        <td style={{ textAlign: "center" }}>
                          <Link to = {`/business/reservation/${reservation.id}`}>
